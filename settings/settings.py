...
SECRET_KEY = "django-insecure-t6orvnul#4$f0=d+m!+36())b^=m^hsmjqiv--#_51gy2-!nq2"
...
STATIC_ROOT = os.path.join(BASE_DIR, 'static')  # Директория для сбора статических файлов (например, с помощью collectstatic)
